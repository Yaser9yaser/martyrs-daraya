    ...
    <div className="min-h-screen bg-gray-50" dir="rtl">
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl shadow p-8">
          ...
          <p className="text-gray-500 mb-6">{martyr.martyrdomDay}/{martyr.martyrdomMonth}/{martyr.martyrdomYear}</p>
          <div className="bg-gray-50 rounded-xl p-4 mb-6">
            <p className="text-gray-700 mb-1">🕌 <strong>المقبرة:</strong> {martyr.cemetery === 'northern' ? 'الشمالية' : 'الجنوبية'}</p>
            <p className="text-gray-700 mb-1">📍 <strong>رقم القبر:</strong> {martyr.graveNumber}</p>
            <p className="text-gray-700">🗺️ <strong>القطاع:</strong> {martyr.section}</p>
          </div>
          ...
          <button onClick={handleSalam} disabled={salamDone}
            className={`w-full p-4 rounded-xl font-bold text-lg transition ${salamDone ? 'bg-green-100 text-green-700' : 'bg-green-700 text-white hover:bg-green-800'}`}>
